...
import { getDespesas, getDespesaCategorias } from "@/lib/data/despesas";
...
export default async function DespesasPage() {
  const [despesas, categorias, pedidos] = await Promise.all([
    getDespesas(),
    getDespesaCategorias(),
    getPedidosSimple(),
  ]);
  ...
  return (
    <>
      ...
      >
        <DespesaFormDialog categorias={categorias} pedidos={pedidos} />
      </PageHeader>
                  ...
                  <TableBody>
                    {despesas.map((d) => (
                      <TableRow key={d.id}>
                        ...
                        <TableCell>
                          <span className="font-medium text-clay-900">{d.categoriaNome}</span>
                          {d.descricao ? (
                        ...
                        <TableCell>
                          <DespesaActions despesa={d} categorias={categorias} pedidos={pedidos} />
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
